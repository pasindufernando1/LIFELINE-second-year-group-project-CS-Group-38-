...
<html lang="en">
    <head>
        <!-- CSS Files -->
        <link href="../../../public/css/systemuser/newpassword.css" rel="stylesheet">
    </head>
    ...
    <body>
        <div class="container">
            ...
            <form class="login-form" action="/forgetpassword/password_set" method="post" id="user-login" name="login-form">

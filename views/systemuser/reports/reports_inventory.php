                    ...
                    <div class="box">
                        ...
                        <form action="/reservation/add_reserve_type" method="post">
                            ...
                            <div class="quantity-container">
                                <label class="quantity-lable" for="Storing_Constraints">Inventory category/Type:</label>
                                <br>
                                <input id="Storing_Constraints" class="quantity-input" type="text" name="Storing_Constraints" autofocus placeholder="Inventory category/Type" required>
                            </div>

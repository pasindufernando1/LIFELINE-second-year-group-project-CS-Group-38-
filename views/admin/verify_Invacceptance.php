...
<body>
    ...
    <div class="box">
        <div class="message-container">
            ...
            <p class="success-msg-txt">Successfully updated the inventories and thanking notifications sent!</p>
            <a href="/inventory/type?page=1" class="brown-button back-to-reserve">Back to inventory</a>

<?php 
$metaTitle = "Campaign archive successful"; 
?>
...
<body>
    ...
    <div class="box">
        <div class="message-container">
            ...
            <p class="success-msg-txt">Successfully archived the campaign !</p>
            <a href="/adcampaigns/type?page=1" class="brown-button back-to-reserve">Back to campaigns</a>

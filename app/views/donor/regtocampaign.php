            ...
            <div class="side-bar">
                <div class="side-nav">
                    ...
                    <div class="box">
                        ...
                        <col style="width:50%">
                        <col style="width:50%">
                        <tr ><td colspan="2"  style="text-align: center;"><h1>Register to Campaign</h1></td></tr>
                        <tr>
                            <td style="text-align: left;" >
                            <label class="reg-lable " for="contno">Contact Number:  </label>
                            <br/>
                            <input class="contno" id="contno"  type="text" name="contno" autofocus value="<?php echo $_SESSION['contno'][0] ?>" required>    
                            <p class="contno-error" id="contno-error" ></p>
                            </td>
                            <td style="text-align: left;" >
                            <label class="reg-lable "  for="emcontno">Emergency Contact Number:  </label>
                            <br/>
                            <input class="emcontno" id="emcontno" type="text" name="emcontno" autofocus placeholder="Emergency Contact Number" required>
                        ...
                        <tr>
                            <td class = "reg-question" >Have you or close relatives had an unexplained neurological condition or been diagnosed with Creutzfeldt-Jacob Disease or ‘mad cow disease’?</td>
                            <td><fieldset><input type="radio" name="g4" value="on" required></td>
                            <td><input type="radio" name="g4" value="off"></fieldset></td></tr>
                        <tr>
                            <td class = "reg-question" >Have you ever injected yourself or been injected with illegal or non-prescribed drugs including body-building drugs or cosmetics (even if this was only once or a long time ago)?</td>
                            <td><fieldset><input type="radio" name="g5" value="on" required></td>
                            <td><input type="radio" name="g5" value="off"></fieldset></td></tr>
                        <tr>
                            <td class = "reg-question" >Have you ever been refused as a blood donor, or told not to donate blood?</td>
                            <td><fieldset><input type="radio" name="g6" value="on" required></td>
                            <td><input type="radio" name="g6" value="off"></fieldset></td></tr>
                        <tr>
                            <td class = "reg-question" >Have you ever had yellow jaundice (excluding jaundice at birth), hepatitis or liver disease or a positive test for hepatitis?</td>
                            <td><fieldset><input type="radio" name="g7" value="on" required></td>
                            <td><input type="radio" name="g7" value="off"></fieldset></td></tr>
                        <tr>
                            <td class = "reg-question" >Have you been ill, received any treatment or taken any medication?</td>
                            <td><fieldset><input type="radio" name="g8" value="on" required></td>
                            <td><input type="radio" name="g8" value="off"></fieldset></td></tr>
                        <tr>
                            <td class = "reg-question" >Have you been under a doctor’s care, undergone surgery, or a diagnostic procedure, suffered a major illness, or been involved in a serious accident?</td>
                            <td><fieldset><input type="radio" name="g9" value="on" required></td>
                            <td><input type="radio" name="g9" value="off"></fieldset></td></tr>
                        <tr>
                            <td class = "reg-question" >have you had close contact with a person with yellow jaundice or viral hepatitis, or have you been given a hepatitis B vaccination</td>
                            <td><fieldset><input type="radio" name="g10" value="on" required></td>
                            <td><input type="radio" name="g10" value="off"></fieldset></td></tr>
                        <tr>
                            <td class = "reg-question" >have you been tattooed, had ear or body piercing, acupuncture, circumcision or scarification, cosmetic treatment?</td>
                            <td><fieldset><input type="radio" name="g11" value="on" required></td>
                            <td><input type="radio" name="g11" value="off"></fieldset></td></tr>
                        <tr >
                            <td colspan="3" style="text-align: center;">
                            <button id="signup-button"class='register2-btn' type='submit' name='reg-to-campaign'>Register To Campaign</button>
                            </td>
                        </tr>
                        </table>

                ...
                <div class="side-nav">
                    ...
                    <div class="box">
                        ...
                        <tr>
                            ...
                            <br/>
                            <input class="reg-input " id="contno"  type="text" name="contno" autofocus placeholder="Contact Number" required>    
                            </td>
                            <td style="text-align: left;" >
                            <label class="reg-lable "  for="emcontno">Emergency Contact Number:  </label>
                            <br/>
                            <input class="reg-input " id="emcontno" type="text" name="emcontno" autofocus placeholder="Emergency Contact Number" required>
                            </td>
                        </tr>
                        </table>
                        <table width="1420px" style="margin-left: auto;margin-right: auto;"  >
                        ...
                        <tr >
                            ...
                            <button class='register2-btn' type='submit' name='reg-to-campaign'>Register To Campaign</button>
                            </td>
                        </tr>
                        </table>

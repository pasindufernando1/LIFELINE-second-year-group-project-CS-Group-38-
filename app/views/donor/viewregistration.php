...
// print_r("view reg info");
// die();
// print_r($_SESSION['selected_campid']);
// die();
// print_r($_SESSION['org_name']);
// die();
                ...
                <div class="side-nav">
                    ...
                    <div class="campaigns menu-item">
                        ...
                        <img class="reservation-non-active "
                            src="./../../public/img/donordashboard/active/campaigns.png" alt="campaigns">
                    ...
                    <div class="box">
                        <p class="update-user-title">Update Campaign Registration details</p>
                        ...
                        <?php echo '<form action="/usermanage/editHospitalMedCenter/' .
                            $_SESSION['user_id'] .
                            '" method="post">'; ?>
                        <div class="quantity-container">
                            <label class="quantity-lable" for="name">Name:</label>
                            <br>
                            <input id="quantity" class="quantity-input" type="text" name="name" value="<?php echo $_SESSION[
                                'Name'
                            ]; ?>" required>
                        </div>
                        <div class="reg-container">
                            ...
                            <br>
                            <input id="regno" class="reg-input" type="text" name="regno" value="<?php echo $_SESSION[
                                'Registration_no'
                            ]; ?>" required>
                        </div>
                        <div class="status-container">
                            ...
                            <br>
                            <input id="status" class="status-input" type="text" name="status" value="<?php echo $_SESSION[
                                'Status'
                            ]; ?>" required>
                        </div>
                        <div class="location-container">
                            ...
                            <br>
                            <input id="number" class="number-input" type="text" name="number" value="<?php echo $_SESSION[
                                'Number'
                            ]; ?>" required>
                            <input id="lane" class="lane-input" type="text" name="lane" value="<?php echo $_SESSION[
                                'LaneName'
                            ]; ?>" required>
                            <input id="city" class="city-input" type="text" name="city" value="<?php echo $_SESSION[
                                'City'
                            ]; ?>" required>
                        ...
                        <div class="email-container">
                            ...
                            <br>
                            <input id="email" class="email-input" type="text" name="email" value="<?php echo $_SESSION[
                                'Email'
                            ]; ?>" required>
                        </div>
                        <div class="contact-container">
                            ...
                            <br>
                            <input id="contact" class="contact-input" type="text" name="contact" value="<?php echo $_SESSION[
                                'Contact_no'
                            ]; ?>" required>
                        </div>
                        <div class="uname-container">
                            ...
                            <br>
                            <input id="uname" class="uname-input" type="text" name="uname" value="<?php echo $_SESSION[
                                'Username'
                            ]; ?>" required>
                        </div>
                        ...
                        <div class="password-container">
                            ...
                            <br>
                            <input id="password" class="password-input" type="text" name="password" autofocus
                        ...
                        <div>
                            <button class='brown-button-update' type='submit' name='update-hosmed'>Update
                                Hospital/Medical Center</button>
                            <img class="addbutton" src="./../../public/img/admindashboard/updateuser.png"
                                alt="edit-button">

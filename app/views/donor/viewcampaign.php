                    ...
                    <?php 
                        if($_SESSION['if_registered']==0){
                            ...
                            <div class="left-box"> 
                                ...
                                <p>Date : '.($_SESSION['campaign_array'][4]).'</p>
                                <p>Starting Time : '.($_SESSION['campaign_array'][5]).'</p>
                                <p>Ending Time : '.($_SESSION['campaign_array'][6]).'</p>
                                <p>Location : '.($_SESSION['campaign_array'][2]).'</p>
                                <p>Number of Beds : '.($_SESSION['campaign_array'][3]).'</p>
                            </div>
                            <div class="right-box">
                                <h1>Registration Details</h1>
                                <p>Emergency Contact Number : '. $_SESSION['reg_info'][0].'</p>
                                <p>Contact Number : '. $_SESSION['reg_info'][1].'</p>
                                <br>
                                <a class="outline-regedit-button" href="#">Update

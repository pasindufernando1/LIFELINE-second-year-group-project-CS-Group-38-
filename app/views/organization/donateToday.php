    ...
    <div class="top-bar">
        ...
        <div class="login-user">
            ...
            <div class="box">
                ...
                <form action="/requestApproval/donate/" method="post" id="addform">
                <img class="donation-img" src="./../../public/img/orgdashboard/donation.png" alt="req" >
                <p class="para1">We are proudly non-profit, non-corporate and non-compromised. we rely on donations to carry out our mission. <b>Will you give today? </b></p>
                <label id="amount-label" class="amount-label" for="amount">Amount(Rs.):</label>
                <br>
                <input class="amount-input" id="amount"  type="text" name="amount" autofocus placeholder="Amount" required>
                <br>

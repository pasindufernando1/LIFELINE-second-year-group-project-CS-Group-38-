    ...
    <div class="top-bar">
        ...
        <div class="login-user">
            ...
            <div class="box">
                ...
                <img class="bed-img" src="./../../public/img/orgdashboard/syringe.jpg" alt="profile">
                <p class="bed-p"><a href="/requestApproval/quantity/">Synringe</a></p>
                <img class="fan-img" src="./../../public/img/orgdashboard/bp.jpg" alt="profile">
                <p class="fan-p"><a href="#">blood Pressure Monitor</a></p>
                <img class="cupboard-img" src="./../../public/img/orgdashboard/forcep.jpg" alt="profile">
                <p class="cupboard-p"><a href="#">Forceps</a></p>
                <img class="chair-img" src="./../../public/img/orgdashboard/mask.jpg" alt="profile">
                <p class="chair-p"><a href="#">Surgical Masks</a></p>
                <img class="table-img" src="./../../public/img/orgdashboard/glouse.jpg" alt="profile">
                <p class="table-p"><a href="#">Surgical Glouse</a></p>
            </div>

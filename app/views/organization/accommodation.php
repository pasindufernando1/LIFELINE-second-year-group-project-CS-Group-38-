...
<body>
    ...
    <?php include($_SERVER['DOCUMENT_ROOT'].'/app/views/organization/layout/header.php'); ?>
            ...
            <div class="box">
                ...
                <img class="bed-img" src="./../../public/img/orgdashboard/bed.jpg" alt="profile">
                <p class="bed-p"><a href="/requestApproval/quantity/">Beds</a></p>
                <img class="fan-img" src="./../../public/img/orgdashboard/fan.jpg" alt="profile">
                <p class="fan-p"><a href="#">Fans</a></p>
                <img class="cupboard-img" src="./../../public/img/orgdashboard/cupboard.jpg" alt="profile">
                <p class="cupboard-p"><a href="#">Cupboards</a></p>
                <img class="chair-img" src="./../../public/img/orgdashboard/chair.jpg" alt="profile">
                <p class="chair-p"><a href="#">Chairs</a></p>
                <img class="table-img" src="./../../public/img/orgdashboard/table.jpg" alt="profile">
                <p class="table-p"><a href="#">Tables</a></p>
            </div>

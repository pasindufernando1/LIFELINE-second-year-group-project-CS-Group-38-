...
<body>
    ...
    <?php include($_SERVER['DOCUMENT_ROOT'].'/app/views/organization/layout/header.php'); ?>
            ...
            <div class="box">
                        ...
                        <button class='brown-button2' type='submit' name='Back' id="brown-button2" ><a href="/requestApproval/viewAcceptedCamps/"  >Back</button>
                        <button class='brown-button3' type='submit' name='add' id="brown-button3" ><a href="/requestApproval/addTimeslot/" >Add New</button>

    ...
    <div class="top-bar">
        ...
        <div class="login-user">
            ...
            <div class="side-bar">
                <div class="side-nav">
                    ...
                    <div class="schedule-time-selected">
                        ...
                        <img class="schedule-time-active" src="./../../public/img/orgdashboard/active/schedule time.png" alt="schedule time">
                        <p class="schedule-time-act "><a href="#">Schedule time</a></p>
                    </div>
            ...
            <div class="box">
                ...
                <div class="chooseMe">
                    <img class="scheduleTime-img" src="./../../public/img/orgdashboard/scheduleTime.gif" alt="req" width=100%>
                    <button class = "scheduleTime-button"><a href="/requestApproval/viewAcceptedCamps">Schedule Time</a></button>
                    
                    <img class="viewSchedule-img" src="./../../public/img/orgdashboard/viewSchedule.gif" alt="campaigns" width=100%>
                    <button class = "viewSchedule-button"><a href="/requestApproval/viewAcceptedCamps">View Schedule</a></button>

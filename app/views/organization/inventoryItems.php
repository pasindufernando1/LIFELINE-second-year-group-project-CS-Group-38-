...
<body>
    ...
    <div class="top-bar">
        ...
        <div class="login-user">
            ...
            <div class="box">
                <p class="inventory-types">Choose the Inventory Items</p>
                <img class="accom-img" src="./../../public/img/orgdashboard/accommodation.gif" alt="req" width=100%>
                    <button class = "accom-button"><a href="/requestApproval/accommodation">Accommodation</a></button>
                    
                    <img class="statio-img" src="./../../public/img/orgdashboard/stationary.gif" alt="campaigns" width=100%>
                    <button class = "statio-button"><a href="/requestApproval/stationaryItems">Stationary items</a></button>
                    <img class="med-img" src="./../../public/img/orgdashboard/medical appliance.gif" alt="feedbacks" width=100%>
                    <button class = "med-button"><a href="/requestApproval/medicalAppliance">Medical Appliance</a></button>
            </div>
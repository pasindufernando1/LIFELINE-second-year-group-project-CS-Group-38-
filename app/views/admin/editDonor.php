                ...
                <div class="side-nav">
                    <div class="dashboard-non menu-item">
                        ...
                        <img class="reservation-non-active dash "
                            src="../../../public/img/dashboard/active/dashboard.png" alt="dashboard">
                        <p class="dashboard-non-active menu-item"><a href="/adminuser/dashboard">Dashboard</a></p>
                    </div>
                    <div class="reservation menu-item">
                        <img class="reservation-active"
                            src="./../../public/img/admindashboard/non-active/reservation.png" alt="reservation">
                        <img class="reservation-non-active"
                            src="./../../public/img/admindashboard/active/reservation.png" alt="reservation">
                    ...
                    <div class="inventory menu-item">
                        ...
                        <img class="reservation-non-active" src="./../../public/img/admindashboard/active/inventory.png"
                            alt="inventory">
                    ...
                    <div class="donors menu-item">
                        ...
                        <img class="reservation-non-active" src="./../../public/img/admindashboard/active/donors.png"
                            alt="donors">
                    ...
                    <div class="reports menu-item">
                        ...
                        <img class="reservation-non-active" src="./../../public/img/admindashboard/active/reports.png"
                            alt="reports">
                    ...
                    <div class="campaigns menu-item">
                        ...
                        <img class="reservation-non-active "
                            src="./../../public/img/admindashboard/active/campaigns.png" alt="campaigns">
                    ...
                    <div class="badges menu-item">
                        ...
                        <img class="reservation-non-active " src="./../../public/img/admindashboard/active/badge.png"
                            alt="campaigns">
                    ...
                    <div class="advertisements menu-item">
                        ...
                        <img class="reservation-non-active " src="./../../public/img/admindashboard/active/ad.png"
                            alt="campaigns">
                    ...
                    <div class="profile menu-item">
                        ...
                        <img class="reservation-non-active" src="./../../public/img/admindashboard/active/profile.png"
                            alt="profile">
                    ...
                    <div class="box">
                        <p class="add-user-title">Update Donor Details</p>
                        ...
                        <?php echo '<form action="/usermanage/editDonor/' .
                            $_SESSION['user_id'] .
                            '" method="post" id="addform">'; ?>
                        <div class="quantity-container">
                            <label class="quantity-lable" for="name">Full name</label>
                            <br>
                            <input id="quantity" class="quantity-input" type="text" name="name"
                        ...
                        <div class="nic-container">
                            ...
                            <br>
                            <input id="nic" class="nic-input" type="text" name="nic"
                                value="<?php echo $_SESSION[
                                    'NIC'
                                ]; ?>" required>
                        </div>
                        <div class="gender-container">
                            ...
                            <br>
                            <select id="gender" class="gender-input" type="text" name="gender" autofocus
                        ...
                        <div class="dob-container">
                            ...
                            <br>
                            <input id="dob" class="dob-input" type="date" name="dob"
                                value="<?php echo $_SESSION[
                                    'DOB'
                                ]; ?>" required>
                        </div>
                        ...
                        <div class="location-container">
                            ...
                            <br>
                            <input id="number" class="number-input" type="text" name="number"
                                value="<?php echo $_SESSION[
                                    'Number'
                                ]; ?>" required>
                            <input id="lane" class="lane-input" type="text" name="lane"
                                value="<?php echo $_SESSION[
                                    'LaneName'
                                ]; ?>" required>
                            <input id="city" class="city-input" type="text" name="city"
                                value="<?php echo $_SESSION[
                                    'City'
                                ]; ?>" required>

                            <select id="district" class="district-input custom-select" type="text" name="district"
                                autofocus placeholder="District" required>
                                <!-- Show placeholder -->
                                <option value="<?php echo $_SESSION[
                                    'District'
                                ]; ?>" hidden>
                            ...
                            <select id="province" class="province-input custom-select" type="text" name="province"
                                autofocus placeholder="Province" required>
                                <!-- Show placeholder -->
                                <option value="<?php echo $_SESSION[
                                    'Province'
                                ]; ?>" hidden>
                        ...
                        <div class="contact-container">
                            ...
                            <br>
                            <input id="contact" class="contact-input" type="text" name="contact"
                                value="<?php echo $_SESSION[
                                    'Contact_no'
                                ]; ?>" required>
                        </div>
                        <div class="uname-container">
                            ...
                            <br>
                            <input id="uname" class="uname-input" type="text" name="uname"
                                value="<?php echo $_SESSION[
                                    'Username'
                                ]; ?>" required>
                        </div>
                        ...
                        <!-- <div class="reserve-id-container">
                                ...
                                <br>
                                <input id="reserve_id" class="reserve-id-input" type="text" name="reserve_id" autofocus placeholder="<?php echo $_SESSION[
                                    'rowCount'
                                ] + 1; ?>" disabled>
                            </div>
                        ...
                        <div>
                            <button id="submit-btn" class='brown-button' type='submit' name='update-donor'>Update
                                Donor</button>
                            <img class="addbutton" src="./../../public/img/admindashboard/add-button.png"
                                alt="add-button">
                            <a class='outline-button' type='reset' name='cancel-adding'
                                href="/usermanage/type?page=1">Cancel Updating</a>
                            <img class="cancelbutton" src="./../../public/img/admindashboard/cancel-button.png"
                                alt="cancel-button">
                        </div>
                        </form>
                    </div>

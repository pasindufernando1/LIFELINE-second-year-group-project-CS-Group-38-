        ...
        <div class="login-user">
            ...
            <div class="side-bar">
                <div class="side-nav">
                    ...
                    <div class="box">
                        <p class="add-user-title">Add Organization/Society</p>
                        ...
                        <form action="/usermanage/addOrganizationSociety" method="post" enctype="multipart/form-data">
                            <div class="quantity-container">
                                ...
                                <br>
                                <input id="quantity" class="quantity-input" type="text" name="name" autofocus placeholder="Organization/Society Name" required>
                            </div>
                            <div class="reg-container">
                                <label id = "regnum-label" class="reg-lable" for="regno">Registration number:</label>
                                <br>
                                <input id="regnum" class="regorg-input" type="text" name="regno" autofocus placeholder="Registration Number" required>
                            </div>
                            ...
                            <div>
                                <button id="submit-btn" class='brown-button' type='submit' name='add-orgsoc'>Add Organization/Society</button>

...
<body>
    ...
    <div class="side-bar">
        <div class="side-nav">
            ...
            <div class="reservation menu-item">
                <img class="reservation-active" src="./../../public/img/admindashboard/non-active/reservation.png"
                    alt="reservation">
                <img class="reservation-non-active" src="./../../public/img/admindashboard/active/reservation.png"
                    alt="reservation">
            ...
            <div class="users menu-item">
                ...
                <img class="reservation-non-active" src="./../../public/img/admindashboard/active/cards.png"
                    alt="donor-cards">
            ...
            <div class="campaigns menu-item">
                ...
                <img class="reservation-non-active " src="./../../public/img/admindashboard/active/campaigns.png"
                    alt="campaigns">
    ...
    <div class="bo1">
        ...
        <p class="te2">
            <?php echo $_SESSION['dashboard_stats']['Today_donations']; ?>
        </p>
    </div>
    ...
    <div class="bo2">
        ...
        <p class="te2">
            <?php echo $_SESSION['dashboard_stats']['Unread_feedbacks'] ?>
        </p>
    ...
    <div class="bo4">
        ...
        <p class="te2">
            <?php echo $_SESSION['dashboard_stats']['Total_hospital_requests'] ?>
        </p>

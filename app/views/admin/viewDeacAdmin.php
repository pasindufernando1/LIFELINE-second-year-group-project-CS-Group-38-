    ...
    <div class="box">
        <p class="update-user-title">Admin details</p>
            ...
            <div>
                ...
                echo '<a href="/usermanage/deactivated_users?filter='.$status.'&page=1"><button class="brown-button-view-admin" type="submit" name="update-hosmed" >Back to deactivated users</button></a>'

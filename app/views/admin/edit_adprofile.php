    ...
    <div class="box">
        <form action="/adprofile/update" method="POST" enctype="multipart/form-data">
            <div class="user-details">
                <div class="image-1">
                    <img id="user_pic" src="../../../public/img/user_pics/<?php echo ($_SESSION['user_pic']);?>"
                        alt="profile-pic">
            ...
            <div class="profile-det">
                <div class="reserve-id-container">
                    ...
                    <br>
                    <input id="Name" class="reserve-id-input" type="text" name="Name"
                        value="<?php echo $_SESSION['username'] ?>">
                </div>
                <div class="blood-group-container">
                    <label id="email-label" class="blood-group-lable" for="Email">Email:</label>
                    <br>
                    <input id="email" class="blood-group-input" type="text" name="email"
                ...
                <div class="quantity-container">
                    ...
                    <br>
                    <input id="password" class="quantity-input" type="text" name="password" autofocus
                ...
                <div class="expiry-constraints-container">
                    ...
                    <br>
                    <input id="contact" class="expiry-constraints-input" type="text" name="contact"
                        value="<?php echo ($_SESSION['user_contact']); ?>">

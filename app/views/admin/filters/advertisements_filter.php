...
<head>
    <link href="../../../public/css/donor/filters/reservation.css" rel="stylesheet">
</head>
...
<body>
    ...
    <div id="idfil01" class="modal">
        ...
        <form class="modal-content" id="del" action="/getcampaign/type?page=1" method="POST">
            ...
            <input type="int" name="date" id="date" placeholder="Date" class="date"> -->
                ...
                <div class="clearfix">
                    ...
                    <button name="filter" type="submit"
                        onclick="document.getElementById('idfil01').style.display='none'"
                        class="deletebtn">Filter</button>
                </div>
            </div>
        </form>
    </div>

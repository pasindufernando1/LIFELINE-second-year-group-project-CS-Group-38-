        ...
        if ($_SESSION['rowCount'] > 0) {
            ...
            foreach(array_slice($result, ($results_per_page*$page - $results_per_page), $results_per_page) as $row) {
                echo '<div class="table-content-types"> <tr>
                        ...
                        <div class="edit-btn-div"> <a href="/usermanage/edit_user/'.$row["UserID"].'"> <img class="edit-btn" src="./../../public/img/admindashboard/edit-btn.png" alt="edit-btn"> </a> </div> 
                        <div class="delete-btn-div"> <a href="/usermanage/delete_user/'.$row["UserID"].'">   <img class="delete-btn" src="./../../public/img/admindashboard/delete-btn.png" alt="delete-btn"> </a> </div> 
                        </div>
                        </td>
                    </tr> </div>';

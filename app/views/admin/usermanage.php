            ...
            <div class="side-bar">
                <div class="side-nav">
                    ...
                    <div class="box">
                        ...
                        <img class="userbutton-user" src="./../../public/img/admindashboard/add-button.png"
                            alt="add-button">

                        <a href="/usermanage/add_hosmed_successful" class="ash-button reservation-filter">Filter &
                            Short</a>
                        <img class="user-filter-img" src="./../../public/img/admindashboard/filter-icon.png"
                            alt="reservation-filter-img">
                        ...
                        <table class="user-types-table" style="width:90%">
                            ...
                            if ($_SESSION['rowCount'] > 0) {
                                foreach (
                                    ...
                                    echo '<div class="table-content-types"> <tr>
                                        ...
                                        $row['Username'] .
                                        '</td>
                                        <td><a href = "/usermanage/view_user/' .
                                        $row['UserID'] .
                                        '"><button class="view-btn" >View</button></a> </td>
                                        <td> <div class="action-btns" ><div class="edit-btn-div"> <a href="/usermanage/edit_user/' .
                                        $row['UserID'] .
                                        '"> <img class="edit-btn" src="./../../public/img/admindashboard/edit-btn.png" alt="edit-btn"> </a> </div> <div class="delete-btn-div"> <a href="/usermanage/delete_user/' .
                                        $row['UserID'] .
                            ...
                            if ($_GET['page'] == 1) {
                                echo '<div class="pag-div"> <a class="pagination-number" href = "?page=' .
                                    1 .
                                    '">&laquo;</a> </div>';
                            } else {
                                echo '<div class="pag-div"> <a class="pagination-number" href = "?page=' .
                            ...
                            for ($page = 1; $page <= $number_of_page; $page++) {
                                if ($page == $_GET['page']) {
                                    echo '<div class="pag-div pag-div-' .
                                        $page .

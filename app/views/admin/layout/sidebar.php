    ...
    <div class="side-bar">
                <div class="side-nav">
                    ...
                    <div class="users menu-item">
                        <img src="./../../public/img/admindashboard/non-active/cards.png" alt="donors">
                    ...
                    <div class="inventory-selected">
                        ...
                        <img src="./../../public/img/admindashboard/active/inventory.png" alt="inventory">
                        <img class="reservation-non-active" src="./../../public/img/admindashboard/active/inventory.png" alt="inventory">
                        <p class="inventory-act "><a href="/inventory/type?page=1">Inventory</a></p>

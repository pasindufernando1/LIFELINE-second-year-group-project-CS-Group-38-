...
<body>
    ...
    <div class="side-bar">
                <div class="side-nav">
                    ...
                    <div class="advertisements-selected">
                        <div class="marker"></div>
                        <img src="./../../public/img/admindashboard/active/ad.png" alt="advertisements">
                        <img class="reservation-non-active " src="./../../public/img/admindashboard/active/ad.png" alt="campaigns">
                        <p class="advertisements-act "><a href="/adadvertisements/type?page=1">Advertisements</a></p>

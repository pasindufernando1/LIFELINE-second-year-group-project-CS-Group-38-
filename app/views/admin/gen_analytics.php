...
<body>
    ...
    <div class="box">
        <p class="entity-select-title">Choose analytics category</p>
                        <!-- Add four buttons -->
        <a href="/usermanage/addSystemUser"><button class="button-type1 user-btn">Productive Donation Areas</button></a>
        <a href="/usermanage/addHospitalMedCenter"><button class="button-type2 user-btn" >Blood Usage vs Expiry</button></a>

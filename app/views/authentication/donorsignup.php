    ...
    <body>
        ...
        <div class="signup-container">
            ...
            <form class="donorsignup-form" action="/donorsignup/send_signup" method="post" id="donor-form" name="donorsignup-form">
                ...
                <br>
                <input id="passwordcheck" class="password-check-input" type="password" name="password-check" autofocus placeholder="Password" required >
                ...
                <table class="reg-table" width="100%"  >
                        ...
                        <tr>
                            ...
                            <td class="options"><fieldset><input type="radio" name="g4" value="on" required></td>
                            <td class="options"><input type="radio" name="g4" value="off"></fieldset></td></tr>
                        <tr>
                        <tr>
                            ...
                            <td class="options"><fieldset><input type="radio" name="g5" value="on" required></td>
                            <td class="options"><input type="radio" name="g5" value="off"></fieldset></td></tr>
                        </table>

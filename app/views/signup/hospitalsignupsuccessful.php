...
<body>
    <div class="container">
        ...
        <div class="sub-2">
            ...
            <p style="font-size:21px;margin-top:220px">Your Registration Information Has Been Successully Sent<br><br>
            <b>Thank you For Joining LIFELINE</b><br><br>
            Once accepted you will be notified via email</p>
        </div>
    </div>
</body>

...
<body>
    <div class="container">
        ...
        <form action="/signup/verify_otp" method="post" id="user-login" name="login-form">
            <label class="username-lable" for="otp">OTP:</label>
            <br>
            <input id="otp" class="username-input" type="text" name="otp" autofocus placeholder="Enter OTP" required>

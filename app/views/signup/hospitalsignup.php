...
<body>
    <div class="container">
        ...
        <form class="hospitalsignup-form" action="/signup/send_hospital_signup/" method="post" id="addform"
            name="hospitalsignup-form">
            <label class="username-lable" for="name">HOSPITAL / MEDICAL CENTER NAME</label>
            <br>
            <input id="username" class="username-input" type="text" name="name" autofocus
                placeholder="Hospital / Medical center name" required>
            <br>
            <label id="reg-label" class="reg-lable" for="regno">REGISTRATION NUMBER</label>
            <br>
            <input id="regno" class="reg-input" type="text" name="regno" autofocus
                placeholder="Ex: PHSRC/PH/01 or PHSRC/MC/01 or PHSRC/GH/01" required>
            <br>
            <label class="address-lable" for="address">POSTAL ADDRESS</label>
            <br>
            <input id="number" class="number-input" type="text" name="number" autofocus placeholder="First line"
                required>
            ...
            <select id="district" class="district-input" type="text" name="district" autofocus placeholder="District"
                required>
            ...
            <select id="province" class="province-input" type="text" name="province" autofocus placeholder="Province"
                required>
            ...
            <br>
            <input id="contact" class="tel-input" type="text" name="tel" autofocus placeholder="Telephone number"
                required>
            <br>
            ...
            <input id="password" class="password-input" type="password" name="password" autofocus placeholder="Password"
                required>
            <br>
            <label id="confirmPassword-label" class="confirmPassword-lable" for="confirmPassword">CONFIRM
                PASSWORD</label>
            <br>
            <input id="confirmPassword" class="confirmPassword-input" type="password" name="confirmPassword" autofocus
                placeholder="Confirm Password" required>
            <br>
            <button id="submit-btn" class='login-button' type='submit' name='login'>SUBMIT</button>

            <div class="signup-p">
                <p>Already have an account? <a href="/user/dashboard/">Login</a></p>

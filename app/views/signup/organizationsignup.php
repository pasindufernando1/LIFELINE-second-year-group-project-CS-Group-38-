...
<body>
    <div class="container">
        ...
        <form class="orgsignup-form" action="/signup/send_organization_signup/" method="post" id="addform"
            name="orgsignup-form">
            ...
            <input id="username" class="username-input" type="text" name="name" autofocus
                placeholder="Organization / Society Name" required>
            <br>
            <label id="regnum-label" class="reg-lable" for="regno">REGISTRATION NUMBER</label>
            <br>
            <input id="regnum" class="reg-input" type="text" name="regno" autofocus placeholder="Registration number"
                required>
            <br>
            ...
            <select id="district" class="district-input custom-select" type="text" name="district" autofocus
            ...
            <select id="province" class="province-input custom-select" type="text" name="province" autofocus

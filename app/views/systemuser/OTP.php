...
<html lang="en">
    <head>
        <!-- CSS Files -->
        <link href="../../../public/css/systemuser/OTP.css" rel="stylesheet">
    </head>
    ...
    <body>
        <div class="container">
            ...
            <form class="login-form" action="/forgetpassword/update_password" method="post" id="user-login" name="login-form">

...
<body>
    ...
    <?php include($_SERVER['DOCUMENT_ROOT'].'/app/views/systemuser/layout/sidebar.php'); ?>
                    <div class="box">
                        <p class="add-reservation-title">Donation Campaign</p>
                        <form action="/reservation/add_reserve_type" method="post">
                            ...
                            <div class="quantity-container">
                                <label class="quantity-lable" for="Storing_Constraints">Date</label>
                                <br>
                                <input id="Storing_Constraints" class="quantity-input" type="date" name="Storing_Constraints" autofocus placeholder="Date" required>
                            </div>
                            <div class="expiry-constraints-container">
                                <label class="expiry-constraints-lable" for="expiry_constraints">Province:</label>
                                <br>
                                <input id="expiry_constraints" class="expiry-constraints-input" type="text" name="expiry_constraints" autofocus placeholder="Province where the inventory is to be checked" required>

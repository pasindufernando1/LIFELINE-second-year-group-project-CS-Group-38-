...
<div id="id01" class="modal">
  ...
  <form class="modal-content" id="del" action="/donors/type?page=1" method="POST">
    ...
    <div>
        ...
        <p id="nic-label">
            ...
            <input name="nic" type="text" placeholder="Enter the NIC of the Donor ...." id="nic" class="input-text"></input>
        </div>
    </div>

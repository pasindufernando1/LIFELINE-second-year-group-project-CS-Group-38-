...
<body>
    ...
    <?php include($_SERVER['DOCUMENT_ROOT'].'/app/views/systemuser/layout/sidebar.php'); ?>
            ...
            <div class="box">
                <?php echo '<p class="add-reservation-title">Edit Blood Reserve: '.$_SESSION['reserve_id'].' </p>'?>;
                <?php echo '<form action="/reservation/edit_reserve/'.$_SESSION['reserve_id'].'" method="post">'?>;
                    ...
                    <div class="expiry-constraints-container">
                        ...
                        <button class='brown-button' type='submit' name='update-reservation'>Update Reservation</button>

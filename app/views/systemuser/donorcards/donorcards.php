...
<body>
    ...
    <?php include($_SERVER['DOCUMENT_ROOT'].'/app/views/systemuser/layout/sidebar.php'); ?>       
                    <div class="box">
                        <p class="add-reservation-title">Donor Card</p>
                        
                        <a href="/donor_cards/add" class="brown-button addnew-reservation">Add New</a>
                        <img class="addbutton-reservation" src="./../../public/img/dashboard/add-button.png" alt="add-button">

                        <a href="/donor_cards/template" class="brown-button types-reservation">Card Edit</a>
                        ...
                        if ($_SESSION['rowCount'] > 0) {
                            ...
                            foreach(array_slice($result, ($results_per_page*$page - $results_per_page), $results_per_page) as $row) {
                                echo '<div class="table-content-types"> <tr>
                                        ...
                                        <td> <div class="action-btns" ><div class="edit-btn-div"> <a href="/donor_cards/view/'.$row["PacketID"].'"> <img class="edit-btn" src="./../../public/img/dashboard/view-icon.png" alt="edit-btn"> </a> </div> <div class="delete-btn-div"> <a href="/reservation/delete_types/'.$row["TypeID"].'">   <img class="delete-btn" src="./../../public/img/dashboard/delete-btn.png" alt="delete-btn"> </a> </div> </div></td>
                                    </tr> </div>';

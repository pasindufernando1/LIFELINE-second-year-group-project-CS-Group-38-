...
<div id="id02" class="modal">
  ...
  <form class="modal-content" id="del" action="/sys_inventory/request?page=1&filtered=1" method="POST">
  
    <div class="container">
      <h1>Filter & Short</h1>
      <a class="removefil" href="/sys_inventory/request?page=1">Remove Filters</a>
    <div>
        <div>
        <p>

...
<div id="id01" class="modal">
  ...
  <form class="modal-content" id="del" action="/reservation/expired_stocks?page=1&filtered=1" method="POST">
  
    <div class="container">
      <h1>Filter & Short</h1>
      <a class="removefil" href="/reservation/expired_stocks?page=1">Remove Filters</a>
    <div>
        <div>
        <p>
            Select Blood Groups

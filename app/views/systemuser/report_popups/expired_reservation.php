...
<div id="r02" class="modal">
  <span onclick="document.getElementById('r02').style.display='none'" class="close" title="Close Modal">×</span>
  <form class="modal-content" id="del" action="/sys_reports?page=1&report=r2generated" method="POST">
  
    <div class="container">
      <h1>Generate Expired Blood Report</h1>
    <div>
        <div>
        <p>
            Select Blood Groups
      ...
      <div class="clearfix">
        <button type="button" onclick="document.getElementById('r02').style.display='none'" class="cancelbtn">Cancel</button>
        <button name="r2" type="submit" class="deletebtn">Generate  </button>
      </div>
    </div>
  </form>
</div>

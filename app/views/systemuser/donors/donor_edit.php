...
<body>
    ...
    <?php include($_SERVER['DOCUMENT_ROOT'].'/app/views/systemuser/layout/sidebar.php'); ?>       
                    <div class="box">
                        <p class="add-user-title">Edit Donor - ID <?php echo $_SESSION['donor_id']; ?></p>
                        ...
                        <form action="/sys_donors/updateDonor/<?php echo $_SESSION['donor_id']; ?>" method="post" enctype="multipart/form-data">
                            <div class="quantity-container">
                                <label class="quantity-lable" for="name">Full name</label>
                                <br>
                                <input id="quantity" class="quantity-inputs" type="text" name="name" value="<?php echo $_SESSION['donor_det'][0]['Fullname']?>" required>
                            </div>
                            <div class="nic-container">
                                <label id="nic-label" class="nic-lable" for="nic">NIC no</label>
                                <br>
                                <input id="nic" class="nic-input" type="text" name="nic" value="<?php echo $_SESSION['donor_det'][0]['NIC']?>" required>
                            </div>
                            <div class="gender-container">
                                <label id="gender-label" class="gender-lable" for="gender">Gender</label>
                                <br>
                                <input id="gender" class="gender-input" type="text" name="gender" value="<?php echo $_SESSION['donor_det'][0]['Gender']?>" required>
                            </div>
                            <div class="dob-container">
                                <label id="dob-label" class="dob-lable" for="dob">DOB</label>
                                <br>
                                <input id="dob" class="dob-input" type="date" name="dob" value="<?php echo $_SESSION['donor_det'][0]['DOB']?>" required>
                            </div>
                            <div class="bloodtype-container">
                                <label class="bloodtype-lable" for="bloodtype">Blood Type</label>
                                <br>
                                <select id="bloodtype" class="bloodtype-input" type="text" name="bloodtype" value="<?php echo $_SESSION['donor_det'][0]['BloodType']?>" required>
                                    <!-- Placeholder -->
                                    <option value="<?php echo $_SESSION['donor_det'][0]['BloodType']?>" selected hidden><?php echo $_SESSION['donor_det'][0]['BloodType']?></option>
                            ...
                            <div class="location-container">
                                ...
                                <br>
                                <input id="number" class="number-input" type="text" name="number" value="<?php echo $_SESSION['donor_det'][0]['Number']?>" required>
                                <input id="lane" class="lane-input" type="text" name="lane" value="<?php echo $_SESSION['donor_det'][0]['LaneName']?>" required>
                                <input id="city" class="city-input" type="text" name="city" value="<?php echo $_SESSION['donor_det'][0]['City']?>" required>
                                
                                <select id="district" class="district-input custom-select" type="text" name="district" value="<?php echo $_SESSION['donor_det'][0]['District']?>"required>
                                        <!-- Show placeholder -->
                                        <option value="<?php echo $_SESSION['donor_det'][0]['District']?>"  selected hidden><?php echo $_SESSION['donor_det'][0]['District']?></option>
                                ...
                                <select id="province" class="province-input custom-select" type="text" name="province" value="<?php echo $_SESSION['donor_det'][0]['Province']?>" required>
                                        <!-- Show placeholder -->
                                        <option value="<?php echo $_SESSION['donor_det'][0]['Province']?>"  selected hidden><?php echo $_SESSION['donor_det'][0]['Province']?></option>
                            ...
                            <div class="email-container">
                                ...
                                <br>
                                <input id="email" class="email-input" type="text" name="email" value="<?php echo $_SESSION['donor_det'][0]['Email']?>" required>
                            </div>
                            <div class="contact-container">
                                <label id="contact-label" class="contact-lable" for="contact">Contact No</label>
                                <br>
                                <input id="contact" class="contact-input" type="text" name="contact" value="<?php echo $_SESSION['donor_det'][0]['ContactNumber']?>" required>
                            </div>

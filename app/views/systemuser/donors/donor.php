...
<body>
    ...
    <?php include($_SERVER['DOCUMENT_ROOT'].'/app/views/systemuser/layout/sidebar.php'); ?>       
                    <div class="box">
                        ...
                        <a href="/sys_reports/category" class="brown-button types-reservation">Make New Report</a>

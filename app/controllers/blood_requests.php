        ...
        if (isset($_SESSION['login'])) {
            if ($_SESSION['type'] == "System User") {
                ...
                if(isset($_GET['filtered'])){
                    $_SESSION['requests'] =$_SESSION['filtered_breq'] ;
                }
                    ...
                    for ($i=0; $i < 8 ; $i++) { 
                        if(isset($_POST[$i])){
                            if(!isset($_POST[10]) && !isset($_POST[11]) && !isset($_POST[12]) && !isset($_POST[13])){
                                $rows = $this->model->getfiltertype($_POST[$i],$BloodBankID,$start,$end);
                                $output = array_merge($output,$rows);
                            }
                            else{
                                if(isset($_POST[10])){
                                    $rows = $this->model->getfiltertypes($_POST[$i],$BloodBankID,$_POST[10],$start,$end);
                                    $output = array_merge($output,$rows);
                                }
                                if(isset($_POST[11])){
                                    $rows = $this->model->getfiltertypes($_POST[$i],$BloodBankID,$_POST[11],$start,$end);
                                    $output = array_merge($output,$rows);
                                }
                                if(isset($_POST[12])){
                                    $rows = $this->model->getfiltertypes($_POST[$i],$BloodBankID,$_POST[12],$start,$end);
                                    $output = array_merge($output,$rows);
                                }
                                if(isset($_POST[13])){
                                    $rows = $this->model->getfiltertypes($_POST[$i],$BloodBankID,$_POST[13],$start,$end);
                                    $output = array_merge($output,$rows);
                                }
                            }

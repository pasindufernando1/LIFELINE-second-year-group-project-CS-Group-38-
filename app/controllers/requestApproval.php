...
class requestApproval extends Controller
{
    ...
    function addRequest()
    {
        if ($_SESSION['type'] == "Organization/Society") {
           ...
           //$BloodBankID=$_POST['bloodbank'];
            ...
            $inputs = array($BloodBankID,$campName,$number,$lane,$city,$district,$province,$beds,$date,$startTime,$endTime,$donors,$advertisementID,$orgID, $Status);
    ...
    function sendNotifications()
    {
        if (isset($_SESSION['login'])) {
            if ($_SESSION['type'] == "Organization/Society") {
                $this->view->render('organization/send_notifications_successful');
                exit;
            } 
        }
        else{
